...
from .utils.countTopics import countTopics
...
def printUpdate(message: str, indent: int = 1): 
    css = f'style="font-family: Courier; margin:2px; padding-left:{20 * indent}px; line-height:1.2;"'
...
class ResearchRunner:
    ...
    def run_research(self):
        try:
            ...
            if self.current_stage == Stage.LEARNING_TOPICS or not self.clustering_agent.is_finished_training():
    ...
    def query(self, query: str): 
        ...
        if self.current_stage != Stage.DONE:
            raise AssertionError('Cannot query until research is finished. Current Stage: ', self.current_stage)
        ...
        try: 
            ...
            return [e for e in counter.most_common()]
        finally: 
            self.__cleanup()
